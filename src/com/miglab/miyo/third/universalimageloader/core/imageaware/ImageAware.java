 ...
 *******************************************************************************/
package com.miglab.miyo.third.universalimageloader.core.imageaware;
 ...
 * through {@link .universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link .universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain .universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link .universalimageloader.core.listener.ImageLoadingListener.onLoadingCancelled(String,
	 ...
	 * {@linkplain .universalimageloader.core.DisplayImageOptions.Builder.showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain .universalimageloader.core.DisplayImageOptions.Builder.showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain .universalimageloader.core.DisplayImageOptions.Builder.showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain .universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link .universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link .universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
